...
std::vector<Image> images; // D�claration du vecteur d'images
...
void Utilisateur::ajouterFavoris(const std::vector<Image>& image) {
    // Exemple d'ajout d'images (vous devez remplacer cela par des images )
...
void Utilisateur::ajouterImage(const Image& image) {
    //Ajouter l'image  la liste d'attente pour l'approbation
...
void Utilisateur::telechargerImage(Image& image) {
    ...
    image.getNomFichier() << "\n";
    //Ajouter l'image t�l�char�e � la galerie de l'utilisateur
